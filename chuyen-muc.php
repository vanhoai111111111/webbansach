...
and chuyenmuc.machuyenmuc = ".$machuyenmuc."";
								...
								<div class="product-grid-content">
									...
									<div class="product-card--body">
										...
										<div class="price-block">
                                            <span class="price"><?php echo ($row['giaban']); ?>đ</span>
                                            <del class="price-old"><?php echo ($row['giagoc']); ?>đ</del>
                                            <span class="price-discount">-<?php echo ($row['giagoc'] - $row['giaban']); ?></span>
                                        </div>
									</div>
								</div> <hr>
